...
import dropdown from '../asset/image/dropdown.svg'
...
export class NavProfile extends React.Component {
      ...
      <Navbar className="navbar" collapseOnSelect expand="lg"  variant="light">
        <Container>
          ...
          <Navbar.Collapse id="responsive-navbar-nav">
            ...
            <Nav className="ml-auto">
              <div className="nav-profile">Slamet <span><img src={dropdown} alt=""/></span></div>
            </Nav>
          </Navbar.Collapse>
        </Container> 
      </Navbar>
...
export class NavKomoditas extends React.Component {
      ...
      <Navbar className="navbar" collapseOnSelect expand="lg"  variant="light">
        <Container>
          ...
          <Navbar.Collapse id="responsive-navbar-nav">
            <Nav className="nav-link">
            <Nav.Link href="/">Beranda</Nav.Link>
              <Nav.Link href="/pembiayaan">Permodalan</Nav.Link>
              <Nav.Link href="/penjualan">Jual</Nav.Link>
